...
const hardwareBackButton = require('./hardware-back-button-1f867b1e.js');
...
const index$3 = require('./index-9bdd4f2a.js');
    ...
    componentDidLoad() {
        {
            rIC(async () => {
                ...
                if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-e52a48f8.js'); }).then((module) => module.startStatusTap());
                }
                ...
                const hardwareBackButtonModule = await Promise.resolve().then(function () { return require('./hardware-back-button-1f867b1e.js'); });
